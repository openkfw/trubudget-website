...
[src/service/domain/errors/event_sourcing_error.ts:31](https://github.com/openkfw/TruBudget/blob/1602d8b/api/src/service/domain/errors/event_sourcing_error.ts#L31)
