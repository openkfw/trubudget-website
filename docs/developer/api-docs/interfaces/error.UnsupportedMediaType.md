...
[src/error.ts:90](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L90)
...
[src/error.ts:89](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L89)
