...
[src/error.ts:17](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L17)
...
[src/error.ts:18](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L18)
