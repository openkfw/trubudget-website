...
[src/error.ts:17](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L17)
...
[src/error.ts:18](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L18)
