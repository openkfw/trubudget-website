...
[src/error.ts:42](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L42)
...
[src/error.ts:41](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L41)
