...
[src/error.ts:42](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L42)
...
[src/error.ts:41](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L41)
