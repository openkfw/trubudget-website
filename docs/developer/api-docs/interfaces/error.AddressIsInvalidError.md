...
[src/error.ts:42](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/error.ts#L42)
...
[src/error.ts:41](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/error.ts#L41)
