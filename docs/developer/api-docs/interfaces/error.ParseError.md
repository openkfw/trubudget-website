...
[src/error.ts:9](https://github.com/openkfw/TruBudget/blob/3b9e793/api/src/error.ts#L9)
...
[src/error.ts:8](https://github.com/openkfw/TruBudget/blob/3b9e793/api/src/error.ts#L8)
...
[src/error.ts:10](https://github.com/openkfw/TruBudget/blob/3b9e793/api/src/error.ts#L10)
