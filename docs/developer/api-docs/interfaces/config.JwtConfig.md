...
[src/config.ts:6](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/config.ts#L6)
...
[src/config.ts:5](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/config.ts#L5)
...
[src/config.ts:4](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/config.ts#L4)
