...
[src/error.ts:33](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L33)
...
[src/error.ts:34](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L34)
