...
[src/error.ts:33](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L33)
...
[src/error.ts:34](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L34)
