...
[src/error.ts:82](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L82)
...
[src/error.ts:81](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L81)
