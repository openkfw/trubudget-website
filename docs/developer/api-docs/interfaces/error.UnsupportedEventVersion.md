...
[src/error.ts:82](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L82)
...
[src/error.ts:81](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L81)
