...
[src/error.ts:49](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L49)
...
[src/error.ts:50](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L50)
