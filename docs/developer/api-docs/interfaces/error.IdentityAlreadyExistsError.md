...
[src/error.ts:49](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/error.ts#L49)
...
[src/error.ts:50](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/error.ts#L50)
