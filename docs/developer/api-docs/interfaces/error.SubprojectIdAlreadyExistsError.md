...
[src/error.ts:57](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L57)
...
[src/error.ts:58](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L58)
