...
[src/error.ts:57](https://github.com/openkfw/TruBudget/blob/0804644/api/src/error.ts#L57)
...
[src/error.ts:58](https://github.com/openkfw/TruBudget/blob/0804644/api/src/error.ts#L58)
