...
[src/error.ts:57](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/error.ts#L57)
...
[src/error.ts:58](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/error.ts#L58)
