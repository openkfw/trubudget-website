...
[src/types.ts:8](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/types.ts#L8)
...
[src/types.ts:9](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/types.ts#L9)
