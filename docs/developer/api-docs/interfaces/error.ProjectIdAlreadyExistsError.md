...
[src/error.ts:65](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/error.ts#L65)
...
[src/error.ts:66](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/error.ts#L66)
