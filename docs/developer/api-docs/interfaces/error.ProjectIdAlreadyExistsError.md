...
[src/error.ts:65](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L65)
...
[src/error.ts:66](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L66)
