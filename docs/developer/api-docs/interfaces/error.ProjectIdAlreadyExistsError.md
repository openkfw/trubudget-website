...
[src/error.ts:65](https://github.com/openkfw/TruBudget/blob/92640998/api/src/error.ts#L65)
...
[src/error.ts:66](https://github.com/openkfw/TruBudget/blob/92640998/api/src/error.ts#L66)
