...
[src/lib/ctx.ts:2](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/lib/ctx.ts#L2)
...
[src/lib/ctx.ts:3](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/lib/ctx.ts#L3)
