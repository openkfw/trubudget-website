...
[src/error.ts:26](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L26)
...
[src/error.ts:25](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/error.ts#L25)
