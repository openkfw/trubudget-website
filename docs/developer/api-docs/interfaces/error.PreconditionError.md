...
[src/error.ts:73](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L73)
...
[src/error.ts:74](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/error.ts#L74)
