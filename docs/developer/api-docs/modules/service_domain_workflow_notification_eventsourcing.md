...
[src/service/domain/workflow/notification_eventsourcing.ts:15](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/service/domain/workflow/notification_eventsourcing.ts#L15)
