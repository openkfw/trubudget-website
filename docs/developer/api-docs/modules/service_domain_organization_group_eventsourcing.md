...
[src/service/domain/organization/group_eventsourcing.ts:16](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/organization/group_eventsourcing.ts#L16)
