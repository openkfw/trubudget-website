...
[src/service/domain/workflow/subproject_permissions_list.ts:19](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/workflow/subproject_permissions_list.ts#L19)
