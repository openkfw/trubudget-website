...
[src/lib/symmetricCrypto.ts:13](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/lib/symmetricCrypto.ts#L13)
...
[src/lib/symmetricCrypto.ts:33](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/lib/symmetricCrypto.ts#L33)
