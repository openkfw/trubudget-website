...
[src/service/domain/workflow/workflowitem_close.ts:39](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/workflow/workflowitem_close.ts#L39)
