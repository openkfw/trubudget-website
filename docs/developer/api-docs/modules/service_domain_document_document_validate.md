...
[src/service/domain/document/document_validate.ts:34](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/document/document_validate.ts#L34)
