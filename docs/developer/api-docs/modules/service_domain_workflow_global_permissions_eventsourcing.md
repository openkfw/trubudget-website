...
[src/service/domain/workflow/global_permissions_eventsourcing.ts:11](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/service/domain/workflow/global_permissions_eventsourcing.ts#L11)
