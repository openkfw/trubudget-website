...
[src/network/controller/vote.ts:76](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/network/controller/vote.ts#L76)
...
[src/network/controller/vote.ts:19](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/network/controller/vote.ts#L19)
