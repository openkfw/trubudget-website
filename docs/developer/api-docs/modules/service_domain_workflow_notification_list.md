...
[src/service/domain/workflow/notification_list.ts:16](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/workflow/notification_list.ts#L16)
