...
[src/service/domain/document/document_upload.ts:34](https://github.com/openkfw/TruBudget/blob/422cbec/api/src/service/domain/document/document_upload.ts#L34)
