...
[src/service/domain/document/document_upload.ts:44](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/document/document_upload.ts#L44)
