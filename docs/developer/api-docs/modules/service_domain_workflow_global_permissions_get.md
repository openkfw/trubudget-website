...
[src/service/domain/workflow/global_permissions_get.ts:15](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/service/domain/workflow/global_permissions_get.ts#L15)
