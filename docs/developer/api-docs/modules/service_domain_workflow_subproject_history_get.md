...
[src/service/domain/workflow/subproject_history_get.ts:17](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/workflow/subproject_history_get.ts#L17)
