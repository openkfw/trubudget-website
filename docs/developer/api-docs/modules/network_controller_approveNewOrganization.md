...
[src/network/controller/approveNewOrganization.ts:10](https://github.com/openkfw/TruBudget/blob/0804644/api/src/network/controller/approveNewOrganization.ts#L10)
