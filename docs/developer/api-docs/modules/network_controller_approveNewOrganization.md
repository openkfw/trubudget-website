...
[src/network/controller/approveNewOrganization.ts:10](https://github.com/openkfw/TruBudget/blob/2e83742/api/src/network/controller/approveNewOrganization.ts#L10)
