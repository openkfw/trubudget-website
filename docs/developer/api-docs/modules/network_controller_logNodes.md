...
[src/network/controller/logNodes.ts:24](https://github.com/openkfw/TruBudget/blob/2e43ea7/api/src/network/controller/logNodes.ts#L24)
...
[src/network/controller/logNodes.ts:9](https://github.com/openkfw/TruBudget/blob/2e43ea7/api/src/network/controller/logNodes.ts#L9)
