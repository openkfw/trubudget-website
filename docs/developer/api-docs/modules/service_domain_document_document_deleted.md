...
[src/service/domain/document/document_deleted.ts:22](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/service/domain/document/document_deleted.ts#L22)
...
[src/service/domain/document/document_deleted.ts:36](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/service/domain/document/document_deleted.ts#L36)
...
[src/service/domain/document/document_deleted.ts:74](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/service/domain/document/document_deleted.ts#L74)
...
[src/service/domain/document/document_deleted.ts:31](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/service/domain/document/document_deleted.ts#L31)
...
[src/service/domain/document/document_deleted.ts:69](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/service/domain/document/document_deleted.ts#L69)
