...
[src/service/domain/permissions.ts:6](https://github.com/openkfw/TruBudget/blob/422cbec/api/src/service/domain/permissions.ts#L6)
...
[src/service/domain/permissions.ts:5](https://github.com/openkfw/TruBudget/blob/422cbec/api/src/service/domain/permissions.ts#L5)
...
[src/service/domain/permissions.ts:8](https://github.com/openkfw/TruBudget/blob/422cbec/api/src/service/domain/permissions.ts#L8)
...
[src/service/domain/permissions.ts:18](https://github.com/openkfw/TruBudget/blob/422cbec/api/src/service/domain/permissions.ts#L18)
