...
[src/network/controller/approveNewNodeForExistingOrganization.ts:10](https://github.com/openkfw/TruBudget/blob/4d7fd4be/api/src/network/controller/approveNewNodeForExistingOrganization.ts#L10)
