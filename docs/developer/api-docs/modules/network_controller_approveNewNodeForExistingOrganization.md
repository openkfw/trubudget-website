...
[src/network/controller/approveNewNodeForExistingOrganization.ts:10](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/network/controller/approveNewNodeForExistingOrganization.ts#L10)
