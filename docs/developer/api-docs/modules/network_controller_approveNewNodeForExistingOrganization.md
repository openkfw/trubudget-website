...
[src/network/controller/approveNewNodeForExistingOrganization.ts:10](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/network/controller/approveNewNodeForExistingOrganization.ts#L10)
