...
[src/network/controller/approveNewNodeForExistingOrganization.ts:10](https://github.com/openkfw/TruBudget/blob/b9aaff0/api/src/network/controller/approveNewNodeForExistingOrganization.ts#L10)
