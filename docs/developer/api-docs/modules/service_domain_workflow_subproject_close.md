...
[src/service/domain/workflow/subproject_close.ts:33](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/workflow/subproject_close.ts#L33)
