...
[src/network/controller/registerNode.ts:12](https://github.com/openkfw/TruBudget/blob/3b9e793/api/src/network/controller/registerNode.ts#L12)
...
[src/network/controller/registerNode.ts:50](https://github.com/openkfw/TruBudget/blob/3b9e793/api/src/network/controller/registerNode.ts#L50)
