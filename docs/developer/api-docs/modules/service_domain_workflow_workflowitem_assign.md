...
[src/service/domain/workflow/workflowitem_assign.ts:30](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/workflow/workflowitem_assign.ts#L30)
