...
[src/service/domain/workflow/workflowitem_get.ts:17](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/workflow/workflowitem_get.ts#L17)
