...
[src/service/domain/document/document_shared.ts:28](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/service/domain/document/document_shared.ts#L28)
...
[src/service/domain/document/document_shared.ts:44](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/service/domain/document/document_shared.ts#L44)
...
[src/service/domain/document/document_shared.ts:39](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/service/domain/document/document_shared.ts#L39)
...
[src/service/domain/document/document_shared.ts:79](https://github.com/openkfw/TruBudget/blob/26ade46/api/src/service/domain/document/document_shared.ts#L79)
