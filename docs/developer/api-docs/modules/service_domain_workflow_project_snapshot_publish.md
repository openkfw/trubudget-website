...
[src/service/domain/workflow/project_snapshot_publish.ts:15](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/service/domain/workflow/project_snapshot_publish.ts#L15)
