...
[src/config.ts:137](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/config.ts#L137)
...
[src/config.ts:214](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/config.ts#L214)
...
[src/config.ts:222](https://github.com/openkfw/TruBudget/blob/2e1b1a6/api/src/config.ts#L222)
