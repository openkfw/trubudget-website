...
[src/service/domain/workflow/project_permission_revoke.ts:22](https://github.com/openkfw/TruBudget/blob/95e6f8a/api/src/service/domain/workflow/project_permission_revoke.ts#L22)
