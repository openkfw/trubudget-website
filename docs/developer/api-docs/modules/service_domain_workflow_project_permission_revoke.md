...
[src/service/domain/workflow/project_permission_revoke.ts:22](https://github.com/openkfw/TruBudget/blob/b9aaff0/api/src/service/domain/workflow/project_permission_revoke.ts#L22)
